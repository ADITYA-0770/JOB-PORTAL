...
import { ArrowLeft, Briefcase, MapPin, DollarSign, Clock, FileText, CheckCircle } from 'lucide-react';
      ...
      <Layout>
        <div className="flex items-center justify-center min-h-[60vh] relative z-10 px-6">
          <div className="bg-white/40 backdrop-blur-md p-12 rounded-3xl shadow-sm border border-[#2D2C2A]/10 text-center max-w-lg w-full relative overflow-hidden">
            ...
            <h2 className="text-3xl font-bold text-[#2c2c2c] tracking-tight uppercase mb-4 relative z-10">Job Posted Successfully!</h2>
            <p className="text-[#2D2C2A]/60 font-medium mb-8 relative z-10">Your job listing is now live and candidates can start applying.</p>
    ...
    <Layout>
      <div className="max-w-4xl mx-auto space-y-10 relative z-10 pb-12 font-sans">
        ...
        <div className="flex flex-col gap-2 mb-8">
          ...
          <p className="text-[#2D2C2A]/60 font-bold uppercase tracking-widest text-sm">Create</p>
          <h1 className="text-5xl font-bold text-[#2c2c2c] tracking-tighter uppercase leading-none">
            Post New <span className="text-[#e8c34f]">Job</span>
          </h1>
        </div>
